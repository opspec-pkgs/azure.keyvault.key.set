[![Build Status](https://github.com/opspec-pkgs/azure.keyvault.key.set/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/azure.keyvault.key.set/actions?query=workflow%3Abuild+branch%3Amain)
